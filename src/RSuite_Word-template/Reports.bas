...
Sub BookmakerReqs()
    ...
    With Redirect_form
        .Caption = "Bookmaker"
        .plain1.Caption = "The 'Bookmaker Request' macro is" & vbNewLine & "now run via a Dropbox workflow." & vbNewLine & "For help please visit:"
        .hyperlink.Caption = "https://confluence.macmillan.com/x/U4AYB"
        .plain2.Caption = "or email:"
        .mail.Caption = "workflows@macmillan.com"
    End With
    Redirect_form.Show
...
Sub MacmillanStyleReport()
    With Redirect_form
        .Caption = "Style Report"
        .plain1.Caption = "The 'Style Report' macro is" & vbNewLine & "now run via a Dropbox workflow." + vbNewLine + "For help please visit:"
        .hyperlink.Caption = "https://confluence.macmillan.com/x/U4AYB"
        .plain2.Caption = "or email:"
        .mail.Caption = "workflows@macmillan.com"
    End With
...
'  End If
  ...
  Dim oProgressBkmkr As Progress_Bar
  Set oProgressBkmkr = New Progress_Bar    ' Triggers Initialize

  'ProgressBkmkr.Title = strTitle
...
Private Function GoodBadStyles(Tor As Boolean, ProgressBar As Progress_Bar, Status As String, ProgTitle As String) As Variant
...
Private Function BadTorStyles(ProgressBar2 As Progress_Bar, StatusBar As String, _
...
Private Function StylesInUse(ProgressBar As Progress_Bar, Status As String, ProgTitle As String) As String
...
Public Function IsHeading(Style As String) As Boolean
    MsgBox ("IS HEADING NEEDS TO BE CREATED")
    IsHeading = True
End Function

Public Function strChapNumber() As String
    MsgBox ("STR CHAP NUMBER NEEDS TO BE CREATED")
    strChapNumber = "CN"
End Function

Public Function strChapTitle() As String
    MsgBox ("STR CHAP TITLE NEEDS TO BE CREATED")
    strChapTitle = "CT"
End Function
