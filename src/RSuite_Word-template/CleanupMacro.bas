...
'
'Public Sub MacmillanManuscriptCleanupSub()
'    Call MacmillanManuscriptCleanup
'End Sub
'
'Private Function MacmillanManuscriptCleanup() As Dictionary
...
'
'  Dim oProgressCleanup As Progress_Bar
'' Triggers Initialize event, which also triggers Show method on PC only
'  Set oProgressCleanup = New Progress_Bar
'
